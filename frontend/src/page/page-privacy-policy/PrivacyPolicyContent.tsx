...
const PagePrivacyPolicyContent: React.FC = () => {
  return (
    <div className="privacy-shell">
      <div className="privacy-paper rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-sm)]">
        <div className="privacy-container">
          ...
          <ul className="privacy-list">
            <li>
              <Trans id="inviarti_aggiornamenti_sul_progetto_open_source" />
            </li>
            <li>
              <Trans id="comunicarti_nuove_funzionalita_eventi_o_opportunita_di_contribuire" />
            </li>
            <li>
              <Trans id="accedere_alla_applicazione" />
            </li>
          </ul>
          ...
          <ul className="privacy-list">
            <li>
              <Trans id="accedere_ai_tuoi_dati_personali" />
            </li>
            <li>
              <Trans id="richiedere_la_correzione_o_la_cancellazione_dei_tuoi_dati" />
            </li>
            <li>
              <Trans id="revocare_il_consenso_al_trattamento" />
            </li>
            <li>
              <Trans id="portabilita_dei_dati" />
            </li>
            <li>
              <Trans id="opporsi_al_trattamento_dei_dati" />
            </li>
          </ul>
          <p className="privacy-text">
