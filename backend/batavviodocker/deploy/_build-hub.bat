...
rem Nota: dentro if (...) serve !var! (EnableDelayedExpansion), altrimenti FE_ENV resta vuoto.
if /i "%~1"=="frontend" (
  set "FE_ENV=!BACKEND_DIR!\..\frontend\.env"
  for %%I in ("!FE_ENV!") do set "FE_ENV=%%~fI"
  ...
  echo [OK] NEXT_PUBLIC_SERVICE_URL presente in !FE_ENV!
)
