...
rem Sul VPS c'e' solo docker-compose.yml (pull immagini Hub).
rem La build locale usa SEMPRE docker-compose.prod.yml (_build-hub.bat).
...
rem Stesso path della cartella prod: da batavviodocker\deploy -> ..\.. = backend
set "BACKEND_DIR=%~dp0..\.."
